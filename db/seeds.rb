...
Bodega.create(nombre: 'Finca La Estacada', web: 'http://www.fincalaestacada.com', email: 'laestacada@laestacada.es', direccion: 'Ctra. Nnal. 400 - Km 103 / Tarancón', provincia_id: '2', cp: '16400', do_id: '3', descripcion: 'Hay tierras cargadas de horizontes y de silencios, tierras duras y pobres, que son, por el contrario, un filón para la viña y el vino. Cuenca es el ejemplo. En el camino que nos lleva a sus tierras altas, dejando Tarancón a la espalda rumbo a la histórica ciudad, se levanta un pequeño templo del vino. No es un lugar de oración para rendir culto al dios Baco sino una nueva bodega de nuestro tiempo.

 FINCA LA ESTACADA es fruto de la ilusión de la familia Cantarero Rodríguez. Su filosofía es la de apostar por revelar el perfil de calidad que poseen los vinos de estas tierras sin que el consumidor tenga que pagar un precio más allá de lo razonable.', img1: 'finca_la_estacada.jpg')